  ...
  return (
    <div className="page-view">
      ...
      <div className="flex-between mb-4">
        <h1 style={{ fontSize:'20px', fontWeight:900, color:'var(--primary)' }}>👥 الحسابات</h1>
        <button className="btn btn-primary" onClick={isCustomers ? openNewCustomer : openNewSupplier}>
          ➕ {isCustomers ? 'عميل جديد' : 'مورد جديد'}
        </button>
      </div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>النقاط</th><th>الفئة</th>
                  <th>إجمالي الزيارات</th><th>إجمالي الإنفاق</th>
                  <th>واتساب</th><th className="no-print">إجراء</th>
                </tr>
              </thead>
              <tbody>
                {custLoading ? (
                  ...
                  <tr><td colSpan="10"><div className="empty-state"><div className="icon">👤</div><p>لا يوجد عملاء</p></div></td></tr>
